...
TEST(ArgParserTestSuite, HelpStringTest) {
  ...
  ASSERT_EQ(
      ...
      "Parser name is: \n"
      "INT argument:\n"
      "Long name: numer Short name:   Default value: false Desription: Some Number\n"
      "STRING argument:\n"
      "Long name: input Short name: i Default value: false Desription: File path for input file\n"
      "FLAG argument:\n"
      "Long name: flag1 Short name: s Default value: true Desription: Use some logic\n"
      "Long name: flag2 Short name: p Default value: false Desription: Use some logic\n"
      "HELP argumen:\n"
      "Is help using: true");
}
